const Map<String, String> arSA = {
  ...
  'snackbar_job_contract_signed': 'تم توقيع عقدك لهذه الوظيفة بنجاح 🎉',
...
""",
  ...
  // 🏆 Level Up Dialog
  // ============================================================
  'level_up_you_are_now_on': 'أنت الآن في المستوى',
  'level_up_how_to': 'كيف تطور مستواك؟',
  'level_up_why_to': 'لماذا تطور مستواك؟',
  'level_up_how_1': 'قدّم على الوظائف لكسب نقاط خبرة',
  'level_up_how_2': 'احصل على القبول وأكمل وظائفك',
  'level_up_how_3': 'احصل على تقييمات إيجابية من أصحاب العمل',
  'level_up_how_4': 'حافظ على نسبة حضور عالية',
  'level_up_how_5': 'ادعُ أصدقاءك للانضمام إلى ParaJob',
  'level_up_why_1': 'احصل على فرصة أكبر للقبول في الوظائف',
  'level_up_why_2': 'افتح مكافآت وهدايا',
  'level_up_why_3': 'احصل على أولوية في الوظائف المطلوبه',
