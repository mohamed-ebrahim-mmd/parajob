const Map<String, String> arSA = {
  ...
  'create_account_location_info': 'تفاصيل العنوان',
  'create_account_loading_cities': 'تحميل المدن...',
  'create_account_city_hint': 'اختر مدينتك',
  'create_account_area_hint': 'اختر منطقتك',
  ...
  "flexible_job_show_case":
      "اعمل وفق جدولك الخاص — اختر الساعات والمواقع التي تناسبك.",
  "non_flexible_job_show_case":
      "وظائف منظمة بساعات عمل ومسؤوليات ثابتة — مثالية لروتين مستقر وثابت.",
  "start_parajob": "ابدأ بذكاء مع ParaJob",
  "start_parajob_desc":
      "تعرّف على كل نوع من الوظائف وافهمه من خلال إرشادات بسيطة وواضحة.",
  "start_now": "ابدأ الان",
  "back": "رجوع",
  "next": "التالي",
  "done": "تم",
  ...
  'profile_job_history_title': 'سجل الوظائف',
  ...
  'auth_choice_continue_with_apple': 'متابعة باستخدام أبل',
  ...
  'login_canceled_title': 'تم إلغاء تسجيل الدخول',
  'login_canceled_message': 'لقد قمت بإلغاء عملية تسجيل الدخول.',
